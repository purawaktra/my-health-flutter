...
class UserPermissionHistoryScreen extends StatefulWidget {
  const UserPermissionHistoryScreen({Key? key}) : super(key: key);

  @override
  _UserPermissionHistoryScreenState createState() =>
      _UserPermissionHistoryScreenState();
}

class _UserPermissionHistoryScreenState
    extends State<UserPermissionHistoryScreen> {
            ...
            child: FutureBuilder<String>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    List<AccessEntry> items = healthRecordAccess.data;
                    items.removeAt(0);
                    return Container(
                        child: ListView(children: [
                      for (AccessEntry item in items)
                        ExpansionTile(
